...
export default function YakitTipSelectbox({ name1, isRequired, onChange, inputWidth, dropdownWidth }) {
  const {
    control,
    setValue,
    formState: { errors },
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await AxiosInstance.get("Material/GetMaterialListByType?type=YAKIT");
