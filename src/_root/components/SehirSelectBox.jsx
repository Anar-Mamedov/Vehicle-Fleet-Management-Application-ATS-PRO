...
export function SehirSelectBox({ name1, isRequired, onChange, inputWidth, dropdownWidth }) {
  const {
    control,
    watch,
    setValue,
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await AxiosInstance.get(`Town/GetTownListForSelectInput`);
