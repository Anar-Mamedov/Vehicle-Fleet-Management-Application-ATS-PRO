...
const Onaylar = () => {
  ...
  const [columns, setColumns] = useState(() => {
    const savedOrder = localStorage.getItem("columnOrderOnaylar");
    const savedVisibility = localStorage.getItem("columnVisibilityOnaylar");
    const savedWidths = localStorage.getItem("columnWidthsOnaylar");
    ...
    localStorage.setItem("columnOrderOnaylar", JSON.stringify(order));
    localStorage.setItem("columnVisibilityOnaylar", JSON.stringify(visibility));
    localStorage.setItem("columnWidthsOnaylar", JSON.stringify(widths));
  ...
  useEffect(() => {
    localStorage.setItem("columnOrderOnaylar", JSON.stringify(columns.map((col) => col.key)));
    localStorage.setItem(
      "columnVisibilityOnaylar",
      JSON.stringify(
        columns.reduce(
          (acc, col) => ({
            ...acc,
  ...
  // Reset columns
  const resetColumns = () => {
    localStorage.removeItem("columnOrderOnaylar");
    localStorage.removeItem("columnVisibilityOnaylar");
    localStorage.removeItem("columnWidthsOnaylar");
