...
const Yakit = () => {
  ...
  const [columns, setColumns] = useState(() => {
    const savedOrder = localStorage.getItem("columnOrderHgsGecisUcretleri");
    const savedVisibility = localStorage.getItem("columnVisibilityHgsGecisUcretleri");
    const savedWidths = localStorage.getItem("columnWidthsHgsGecisUcretleri");
    ...
    localStorage.setItem("columnOrderHgsGecisUcretleri", JSON.stringify(order));
    localStorage.setItem("columnVisibilityHgsGecisUcretleri", JSON.stringify(visibility));
    localStorage.setItem("columnWidthsHgsGecisUcretleri", JSON.stringify(widths));
  ...
  useEffect(() => {
    localStorage.setItem("columnOrderHgsGecisUcretleri", JSON.stringify(columns.map((col) => col.key)));
    localStorage.setItem(
      "columnVisibilityHgsGecisUcretleri",
      JSON.stringify(
        columns.reduce(
          (acc, col) => ({
            ...acc,
  ...
  // Reset columns
  const resetColumns = () => {
    localStorage.removeItem("columnOrderHgsGecisUcretleri");
    localStorage.removeItem("columnVisibilityHgsGecisUcretleri");
    localStorage.removeItem("columnWidthsHgsGecisUcretleri");
