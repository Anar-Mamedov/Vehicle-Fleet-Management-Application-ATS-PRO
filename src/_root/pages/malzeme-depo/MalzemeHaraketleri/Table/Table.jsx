...
const MalzemeHareketleri = () => {
    ...
    () => [
      ...
      },
      {
        ...
        sorter: (a, b) => {
          ...
          return a.miktar.localeCompare(b.miktar);
        },
      },
      {
        title: t("birim"),
  ...
  const [columns, setColumns] = useState(() => {
    const savedOrder = localStorage.getItem("columnOrderMalzemeHareketleri");
    const savedVisibility = localStorage.getItem("columnVisibilityMalzemeHareketleri");
    const savedWidths = localStorage.getItem("columnWidthsMalzemeHareketleri");
    ...
    localStorage.setItem("columnOrderMalzemeHareketleri", JSON.stringify(order));
    localStorage.setItem("columnVisibilityMalzemeHareketleri", JSON.stringify(visibility));
    localStorage.setItem("columnWidthsMalzemeHareketleri", JSON.stringify(widths));
  ...
  useEffect(() => {
    localStorage.setItem("columnOrderMalzemeHareketleri", JSON.stringify(columns.map((col) => col.key)));
    localStorage.setItem(
      "columnVisibilityMalzemeHareketleri",
      JSON.stringify(
        columns.reduce(
          (acc, col) => ({
            ...acc,
    ...
    localStorage.setItem(
      "columnWidthsMalzemeHareketleri",
      JSON.stringify(
        columns.reduce(
          (acc, col) => ({
            ...acc,
  ...
  // Reset columns
  const resetColumns = () => {
    localStorage.removeItem("columnOrderMalzemeHareketleri");
    localStorage.removeItem("columnVisibilityMalzemeHareketleri");
    localStorage.removeItem("columnWidthsMalzemeHareketleri");
...
export default memo(MalzemeHareketleri);
