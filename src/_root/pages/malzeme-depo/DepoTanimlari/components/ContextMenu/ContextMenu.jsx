...
import DepoStokDurumlari from "./components/DepoStokDurumlari";
...
export default function ContextMenu({ selectedRows, refreshTableData }) {
  ...
  const content = (
    <div>
      ...
      {selectedRows.length == 1 && <DepoStokDurumlari selectedRows={selectedRows} refreshTableData={refreshTableData} hidePopover={hidePopover} />}
    </div>
  );
  return (
