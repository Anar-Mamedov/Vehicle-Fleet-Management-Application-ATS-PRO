...
import MalzemeDepoDagilimi from "./components/MalzemeDepoDagilimi";
...
export default function ContextMenu({ selectedRows, refreshTableData }) {
  ...
  const content = (
    <div>
      ...
      {selectedRows.length == 1 && <MalzemeDepoDagilimi selectedRows={selectedRows} refreshTableData={refreshTableData} hidePopover={hidePopover} />}
    </div>
  );
  return (
