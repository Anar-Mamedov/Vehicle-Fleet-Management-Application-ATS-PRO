...
export default function DetailTablesSection({ failureData, expenseData, onRefreshType }) {
  return (
    <>
      ...
      <Space direction="vertical" size={16} style={{ width: "100%" }}>
        <AdvancedFailureTable data={failureData} onRefresh={() => onRefreshType(13)} />
        <OperatingExpenseTable data={expenseData} onRefresh={() => onRefreshType(14)} />
      </Space>
    </>
  );
}
