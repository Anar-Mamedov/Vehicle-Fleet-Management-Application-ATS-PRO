  ...
  const onSumbit = handleSubmit((values) => {
    const body = values.stSatildi
      ? {
          ...
          stNoterSatisTarih: values.stNoterSatisTarih ? dayjs(values.stNoterSatisTarih).format("YYYY-MM-DD") : null,
          stTarih: values.stTarih ? dayjs(values.stTarih).format("YYYY-MM-DD") : null,
          stFaturaTarih: values.stFaturaTarih ? dayjs(values.stFaturaTarih).format("YYYY-MM-DD") : null,
