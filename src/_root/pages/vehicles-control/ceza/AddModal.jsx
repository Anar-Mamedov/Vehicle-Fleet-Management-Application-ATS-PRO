...
const AddModal = ({ setStatus, onRefresh }) => {
  ...
  const onSubmit = handleSubmit((values) => {
    const body = {
      ...
      odemeTarih: values.odemeTarih ? dayjs(values.odemeTarih).format("YYYY-MM-DD") : null,
      odeme: values.odeme,
      ...
      tebligTarih: values.tebligTarih ? dayjs(values.tebligTarih).format("YYYY-MM-DD") : null,
      ...
      odendigiTarih: values.odendigiTarih ? dayjs(values.odendigiTarih).format("YYYY-MM-DD") : null,
    };
