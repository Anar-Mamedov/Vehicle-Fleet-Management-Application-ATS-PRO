...
const SigortaTablo = ({ customFields }) => {
  ...
  const fetchDataWithDurum = async (diff, targetPage, currentSize = pageSize) => {
    ...
    try {
      ...
      const response = await AxiosInstance.post(
        `Insurance/GetInsuranceList?diff=${diff}&setPointId=${currentSetPointId}&parameter=${searchTerm}&pageSize=${currentSize}`,
        customFilters
      );
