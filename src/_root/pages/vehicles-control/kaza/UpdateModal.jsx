...
const UpdateModal = ({ updateModal, setUpdateModal, id, aracId, setStatus, selectedRow, onDrawerClose, drawerVisible, onRefresh }) => {
  ...
  const onSubmit = handleSubmit((values) => {
    const body = {
      ...
      kazaTarih: values.kazaTarih && dayjs(values.kazaTarih).isValid() ? dayjs(values.kazaTarih).format("YYYY-MM-DD") : null,
      faturaTarih: values.faturaTarih && dayjs(values.faturaTarih).isValid() ? dayjs(values.faturaTarih).format("YYYY-MM-DD") : null,
      geriOdemeTarih: values.geriOdemeTarih && dayjs(values.geriOdemeTarih).isValid() ? dayjs(values.geriOdemeTarih).format("YYYY-MM-DD") : null,
      ...
      kazaSaat: values.kazaSaat && dayjs(values.kazaSaat).isValid() ? dayjs(values.kazaSaat).format("HH:mm:ss") : null,
